            ...
            <nav class="col-md-2  sidebar border-right bg-light rounded-right">
                ...
                <div class="bg-light border-right" id="sidebar-wrapper">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="{{route('user.choose_category')}}"
                           class="list-group-item list-group-item-action bg-light">Создать
                            обьявление</a>
                    ...
                    <div class="col-sm-4 d-flex pb-3">
                        <div class="card mb-4 shadow-sm">
                            ...
                            <h3 style="position: absolute ;"><span
                                    class="badge badge-secondary">{{$ad->city->name}}</span>
                            </h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <form action="{{ route('user.delete_ad',['id'=>$ad->id]) }}" method="POST">
                                            ...
                                            @csrf
                                            <button type="submit"
                                                    class="btn btn-danger close"><span aria-hidden="true">&times;</span>
                                            </button>
                                        </form>
                                    </div>
                                </div>
